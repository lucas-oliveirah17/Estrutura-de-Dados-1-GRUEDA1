/*
•Monte o programa Fila estática, posicionando as
 chamadas das funções no main(), para manipulação
 da Fila, de forma que apresentem o funcionamento e as
 mensagens iguais ao exemplo ao lado.
